<script lang="ts">
	let classPreview = 'grid grid-cols-11 gap-4 text-center font-mono text-sm bg-neutral-50-950';
</script>

<div class="container max-h-svh overflow-y-scroll">
	<section class={classPreview}>
		<!-- Neutral 50 -->
